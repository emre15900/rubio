...
<body>
    ...
    <main class="main__content_wrapper">
        ...
        <!-- Start breadcrumb section -->
          <?php $title = 'Product Details'; $subtitle = 'Product Details'; ?>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="<?= $product['img']; ?>"><img class="product__media--preview__items--img" src="<?= $product['img']; ?>" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="<?= $product['img']; ?>" data-gallery="product-media-preview">
                        ...
                        <div class="product__details--info">
                            <form action="#">
                                ...
                                <div class="product__details--info__price mb-10">
                                    <span class="current__price"><?= 'NGN'.$product['price']; ?></span>
                                    <span class="price__divided"></span>
                                    <span class="old__price"><?= 'NGN'.rand(23, 98); ?></span>
                                </div>
                                ...
                                <!-- <div class="guarantee__safe--checkout">
                                    ...
                                    <img class="guarantee__safe--checkout__img" src="https://risingtheme.com/html/demo-suruchi-v1/suruchi/assets/img/other/safe-checkout.png" alt="Payment Image">
                                </div> -->
                            </form>
                        </div>
                    </div>
                                        ...
                                        <div class="reviews__comment--area">
                                            <div class="reviews__comment--list d-flex">
                                                <div class="reviews__comment--thumb">
                                                    <img src="https://risingtheme.com/html/demo-suruchi-v1/suruchi/assets/img/other/comment-thumb1.png" alt="comment-thumb">
                                                </div>
                                            ...
                                            <div class="reviews__comment--list margin__left d-flex">
                                                <div class="reviews__comment--thumb">
                                                    <img src="https://risingtheme.com/html/demo-suruchi-v1/suruchi/assets/img/other/comment-thumb2.png" alt="comment-thumb">
                                                </div>
                                                <div class="reviews__comment--content">
                                                    <div class="reviews__comment--top d-flex justify-content-between">
                                                        <div class="reviews__comment--top__left">
                                            ...
                                            <div class="reviews__comment--list d-flex">
                                                <div class="reviews__comment--thumb">
                                                    <img src="https://risingtheme.com/html/demo-suruchi-v1/suruchi/assets/img/other/comment-thumb3.png" alt="comment-thumb">
                                                </div>
                                                <div class="reviews__comment--content">
                                                    <div class="reviews__comment--top d-flex justify-content-between">
                                                        <div class="reviews__comment--top__left">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="quickview__thumb">
                                        <a class="quickview__thumb--link" href="product-details.html"><img class="quickview__thumb--img" src="https://risingtheme.com/html/demo-suruchi-v1/suruchi/assets/img/product/big-product2.jpg" alt="product-img"></a>
                                ...
                                <div class="swiper-slide">
                                    <div class="quickview__thumb">
                                        <a class="quickview__thumb--link" href="product-details.html"><img class="quickview__thumb--img" src="https://risingtheme.com/html/demo-suruchi-v1/suruchi/assets/img/product/big-product3.jpg" alt="product-img"></a>
                                        <div class="product__badge">
                                            <span class="product__badge--items sale">Sale</span>
                                        </div>
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="quickview__thumb">
                                        <a class="quickview__thumb--link" href="product-details.html"><img class="quickview__thumb--img" src="https://risingtheme.com/html/demo-suruchi-v1/suruchi/assets/img/product/big-product4.jpg" alt="product-img"></a>
                                        <div class="product__badge">
                                            <span class="product__badge--items sale">Sale</span>
                                        </div>
                                    </div>
                                ...
                                <div class="product__variant">
                                    <div class="product__variant--list mb-15">
                                        <fieldset class="variant__input--fieldset">
                                            ...
                                            <label class="variant__color--value red" for="color-red5" title="Red"><img class="variant__color--value__img" src="https://risingtheme.com/html/demo-suruchi-v1/suruchi/assets/img/product/product1.png" alt="variant-color-img"></label>
                                            <input id="color-red6" name="color" type="radio">
                                            <label class="variant__color--value red" for="color-red6" title="Black"><img class="variant__color--value__img" src="https://risingtheme.com/html/demo-suruchi-v1/suruchi/assets/img/product/product2.png" alt="variant-color-img"></label>
                                            <input id="color-red7" name="color" type="radio">
                                            <label class="variant__color--value red" for="color-red7" title="Pink"><img class="variant__color--value__img" src="https://risingtheme.com/html/demo-suruchi-v1/suruchi/assets/img/product/product3.png" alt="variant-color-img"></label>
                                            <input id="color-red8" name="color" type="radio">
                                            <label class="variant__color--value red" for="color-red8" title="Orange"><img class="variant__color--value__img" src="https://risingtheme.com/html/demo-suruchi-v1/suruchi/assets/img/product/product4.png" alt="variant-color-img"></label>
                                        </fieldset>
                                    </div>
                                    <div class="product__variant--list mb-15">
                                        <fieldset class="variant__input--fieldset weight">
