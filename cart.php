                                            ...
                                            <tbody class="cart__table--body">
                                                <?php foreach($cart_items as $item): ?>
                                                    ...
                                                    <tr class="cart__table--body__items">
                                                        ...
                                                        <td class="cart__table--body__list">
                                                            <span class="cart__price end"><?= $currency.convert_currency($item['price']); ?></span>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            </tbody>
                                            ...
                                            <table class="cart__summary--total__table">
                                                <tbody>
                                                    <tr class="cart__summary--total__list">
                                                        ...
                                                        <td class="cart__summary--amount text-right">NGN<?= ($currency ?? 'NGN').convert_currency(array_sum($total)); ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
