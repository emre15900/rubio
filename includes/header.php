      ...
      <div class="container-fluid">
          <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
              ...
              <div class="header__search--widget header__sticky--none d-none d-lg-block">
                  <form class="d-flex header__search--form" method="GET" action="<?= BASE_URL; ?>/shop.php">
                      ...
                      <div class="header__search--box">
                          <label>
                              <input class="header__search--input" placeholder="Keyword here..." type="text" name="query" value="<?= isset($_GET['query']) ? $_GET['query'] : ''; ?>">
                          </label>
                  ...
                  <nav class="header__menu--navigation">
                      <ul class="d-flex">
                        ...
                        <li class="header__menu--items mega__menu--items style2">
                          ...
                          <?php if(empty($user)): ?>
                            <li class="header__menu--items style2">
                                <a class="header__menu--link" href="<?= BASE_URL; ?>/login.php">Login</a>
                            </li>
                            <li class="header__menu--items style2">
                                <a class="header__menu--link" href="<?= BASE_URL; ?>/signup.php">Signup</a>
                            </li>
                          <?php endif; ?>
                      </ul>
                  </nav>
  ...
  <div class="header__bottom">
      <div class="container-fluid">
          <div class="header__bottom--inner position__relative d-none d-lg-flex justify-content-between align-items-center">
              ...
              <p class="header__discount--text"><img class="header__discount--icon__img" src="https://risingtheme.com/html/demo-suruchi-v1/suruchi/assets/img/icon/lamp.png" alt="lamp-img"> Special up to 60% Off all item</p>
          </div>
      </div>
  </div>
