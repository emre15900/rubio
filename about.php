...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Rubio - About Us</title>
    <meta name="description" content="RUBIO SHOPPING" />
              ...
              <div class="about__thumb d-flex">
                <div class="about__thumb--items">
                  <img
                    ...
                    src="https://risingtheme.com/html/demo-suruchi-v1/suruchi/assets/img/other/about-thumb-list1.png"
                    alt="about-thumb"
                  />
                </div>
                <div class="about__thumb--items position__relative">
                  <img
                    class="about__thumb--img border-radius-5 display-block"
                    src="https://risingtheme.com/html/demo-suruchi-v1/suruchi/assets/img/other/about-thumb-list2.png"
                    alt="about-thumb"
                  />
            ...
            <div class="col-lg-6">
              <div class="about__content">
                ...
                <p class="about__content--desc mb-20">
                  Welcome to Rubio, your ultimate online shopping
                  destination! Founded with a passion for delivering
                  unparalleled shopping experiences, Rubio brings you a
                  diverse range of high-quality products right at your
                  fingertips.
                </p>
                <p class="about__content--desc mb-25">
                  At Rubio, we believe that shopping should be more than
                  just a transaction; it should be an immersive journey. Our
                  commitment to excellence drives us to curate a collection that
                  caters to your every need. Whether you're searching for the
                  latest fashion trends, innovative electronics, home
                  essentials, or unique gifts, we've got you covered.
                </p>
                <div
                  class="about__author position__relative d-flex align-items-center"
                >
                  ...
                  <img
                    class="about__author--signature display-block"
                    src="https://risingtheme.com/html/demo-suruchi-v1/suruchi/assets/img/icon/signature.png"
                    alt="signature"
                  />
                </div>
              </div>
                ...
                <div class="team__items text-center">
                  <div class="team__thumb">
                    <img
                      ...
                      src="https://risingtheme.com/html/demo-suruchi-v1/suruchi/assets/img/other/team1.png"
                      alt=""
                    />
                  </div>
                  <div class="team__content">
                    ...
                    <ul
                      class="team__social d-flex justify-content-center align-items-center"
                    >
              ...
              <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col">
                <div class="team__items text-center">
                  <div class="team__thumb">
                    <img
                      class="team__thumb--img border-radius-50"
                      src="https://risingtheme.com/html/demo-suruchi-v1/suruchi/assets/img/other/team2.png"
                      alt=""
                    />
                  </div>
                  <div class="team__content">
              ...
              <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col">
                <div class="team__items text-center">
                  <div class="team__thumb">
                    <img
                      class="team__thumb--img border-radius-50"
                      src="https://risingtheme.com/html/demo-suruchi-v1/suruchi/assets/img/other/team3.png"
                      alt=""
                    />
                  </div>
                  <div class="team__content">
              ...
              >
                <div class="brand__logo--items">
                  <img
                    ...
                    src="https://risingtheme.com/html/demo-suruchi-v1/suruchi/assets/img/logo/brand-logo1.png"
                    alt="brand logo"
                  />
                </div>
                <div class="brand__logo--items">
                  <img
                    class="brand__logo--items__thumbnail--img display-block"
                    src="https://risingtheme.com/html/demo-suruchi-v1/suruchi/assets/img/logo/brand-logo2.png"
                    alt="brand logo"
                  />
                </div>
                <div class="brand__logo--items">
                  <img
                    class="brand__logo--items__thumbnail--img display-block"
                    src="https://risingtheme.com/html/demo-suruchi-v1/suruchi/assets/img/logo/brand-logo3.png"
                    alt="brand logo"
                  />
                </div>
                <div class="brand__logo--items">
                  <img
                    class="brand__logo--items__thumbnail--img display-block"
                    src="https://risingtheme.com/html/demo-suruchi-v1/suruchi/assets/img/logo/brand-logo4.png"
                    alt="brand logo"
                  />
                </div>
                <div class="brand__logo--items">
                  <img
                    class="brand__logo--items__thumbnail--img display-block"
                    src="https://risingtheme.com/html/demo-suruchi-v1/suruchi/assets/img/logo/brand-logo5.png"
                    alt="brand logo"
                  />
                </div>
              </div>
