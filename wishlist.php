        ...
        <section class="cart__section section--padding">
            <div class="container">
                <?php if(empty($wishlist)): ?>
                    <div class="alert-info px-4 py-3">No wishlist items</div>
                <?php else: ?>
                        ...
                        <form action="#">
                            ...
                            <div class="cart__table">
                                        ...
                                        <?php foreach($wishlist as $item): ?>
                                            <tr class="cart__table--body__items">
                                                <td class="cart__table--body__list">
                                                    <div class="cart__product d-flex align-items-center">
                                                        ...
                                                        <div class="cart__thumbnail">
                                                            <a href="<?= BASE_URL; ?>/product.php?id=<?= $item['id']; ?>"><img class="border-radius-5" src="<?= $product['img']; ?>" alt="cart-product"></a>
                                                        </div>
                                                ...
                                                <td class="cart__table--body__list text-right">
                                                    <a class="wishlist__cart--btn primary__btn" href="<?= BASE_URL; ?>/cart.php?product_id=<?= $item['id']; ?>">Add To Cart</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                ...
                                <div class="continue__shopping d-flex justify-content-between">
                                    ...
                                    <a class="continue__shopping--clear" href="<?= BASE_URL; ?>/shop.php">View All Products</a>
                                </div>
                            </div>
                        </form>
                    </div>
